                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="input-row">
                            ...
                            <input type="hidden" name="category_id" value = "<?= $data['id'] ?>">
                                ...
                                <input type="text" name="name" value ="<?= $data['name'] ?>" required placeholder="Enter Category Name">
                            </div>
                        ...
                        <div class="input-row">
                            <div class="input-group">
                                ...
                                <textarea rows="3" name="description" required placeholder="Enter Description"><?= $data['description'] ?></textarea>
                            </div>
                        ...
                        <div class="input-row1">
                            <div class="input-group">
                                ...
                                <img src="../uploads/<?= $data['image'] ?>" height="75px" width = "75px" alt="">
                            </div>
                        </div>    
                        <div class="input-row">
                            ...
                            <div class="inputgroup">
                                ...
                                <input type="text" name="meta_title" value ="<?= $data['meta_title'] ?>" required placeholder="Enter Meta Title">
                            </div>	
                            </div>			
                        </div>
                        <div class="input-row">
                            <div class="input-group">
                                ...
                                <textarea rows="3"  name="meta_description" placeholder="Enter Meta Description"><?= $data['meta_description'] ?></textarea>
                            </div>
                        </div>
                        <div class="input-row">
                            <div class="input-group">
                                <label><b>Meta Keyword</b></label>	
                                <textarea rows="3"   name="meta_keywords"  placeholder="Enter Meta Keywords" ><?= $data['meta_keywords'] ?></textarea>
                            </div>
                        </div>
                        ...
                        <button type="submit" name="update_category_btn">Update</button>
                    </form>
            </div>
            </div>
        <?php
