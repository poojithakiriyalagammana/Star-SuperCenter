        ...
        <form action="code.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-row">
					<div class="input-group">
                        ...
                        <select name = "category_id" id="standard-select" required>
                ...
                <div class="input-row">
                    <div class="input-group">
						...
						<textarea rows="3" name="small_description" required placeholder="Enter Small Description"></textarea>
					</div>
                </div>    
                <div class="input-row">
                    <div class="input-group">
                ...
                <div class="input-row">
					<div class="input-group">
						...
						<input type="number" name="original_price" required placeholder="Enter Original Price">
					</div>
					
					<div class="input-group">
						<label><b>Selling Price</b></label>	
						<input type="number" name="selling_price" required placeholder="Enter Selling Price">
					</div>    	
                </div>
                ...
                <button type="submit" name="add_product_btn">Save</button>
			</form>
      </div>
    </div>
<style>
